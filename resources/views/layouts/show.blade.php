			...
			<div class="py-container">
				<div class="shortcut">
					@if(session('logins'))
                        ...
                        <li class="f-item">{{session('logins')->name}}   　<span><a href="{{url('/dell')}}">退出登录</a></span></li>
                        </ul>
                    @else
                        <ul class="fl">
                            <li class="f-item">品优购欢迎您！</li>
				...
				<div class="yui3-g NavList">
					...
					<div class="yui3-u Center navArea">
						<ul class="nav">
							...
							<li class="f-item"><a href="{{url('/prize')}}" target="_blank">抽奖</a></li>
							<li class="f-item"><a href="{{url('/seckill_index')}}" target="_blank">秒杀</a></li>
						</ul>
					</div>
